...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  'settings.activity.emptyBody': 'Start a CLI or app session and completed model replies will appear here.',
  ...
  'settings.plugins.description': 'Inspect installed plugins, see their health, and apply changes to the active runtime.',
  'settings.plugins.browserTitle': 'Browse installed plugins',
  'settings.plugins.browserEyebrow': 'Plugin Manager',
  'settings.plugins.browserDescription': 'Plugins bundle skills, agents, hooks, MCP servers, and language tooling. Manage installed plugins, health, and apply-to-runtime feedback here.',
  ...
  'scheduledPage.desktopNotice': 'Scheduled tasks run while the cc-haha server is active. Keep the Desktop app or Web server running for tasks to fire on time.',
  ...
  'trace.list.emptyBody': 'When collection is enabled, new sessions write model-call traces to the server traces directory.',
