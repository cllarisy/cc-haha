...
9번째 줄 8칸 전부: 앞 줄에 이어 정면 아래에서 왼쪽으로 돌아 왼쪽 아래, 왼쪽, 왼쪽 위를 지나 정면 위 직전까지`,
  ...
  'settings.activity.emptyBody': 'CLI 또는 앱 세션을 시작하면 완료된 모델 응답이 여기에 표시됩니다.',
  ...
  'settings.plugins.description': '설치된 플러그인을 확인하고 상태를 파악하며 현재 런타임에 변경 사항을 적용합니다.',
  'settings.plugins.browserTitle': '설치된 플러그인 살펴보기',
  'settings.plugins.browserEyebrow': '플러그인 관리자',
  'settings.plugins.browserDescription': '플러그인은 스킬, 에이전트, 후크, MCP 서버, 언어 도구를 묶은 것입니다. 여기에서 설치된 플러그인, 상태, 런타임 적용 결과를 관리할 수 있습니다.',
  ...
  'scheduledPage.desktopNotice': '예약 작업은 cc-haha 서버가 실행 중일 때 동작합니다. Desktop 앱 또는 Web 서버를 계속 실행해 두세요.',
  ...
  'trace.list.emptyBody': '수집을 켜면 새 세션이 모델 호출 트레이스를 서버 traces 디렉터리에 기록합니다.',
